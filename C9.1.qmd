...
$$\Large \texttt{ic_media_sigma(x_barra, sigma, n, confianza)}$$
...
$$\Large \texttt{ic_media_t(datos, confianza)}$$
...
$$\Large \texttt{ic_media_t(x_barra, s, n, confianza)}$$
...
$$\Large \texttt{ic_varianza(datos, confianza)}$$
...
$$\Large \texttt{ic_varianza(s, n, confianza)} $$
...
$$\Large \texttt{ic_proporcion(x, n, confianza)}$$
